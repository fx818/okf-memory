...
5. **Present the plan and get approval before writing.** List the concept files you'll create with their one-line descriptions. Wait for the user to confirm or adjust.

6. **Write the bundle** using the skill's templates:
...
7. **Tell the user** what was created and that future sessions will auto-load `index.md`. Suggest committing `.knowledge/` so the memory travels with the repo.
